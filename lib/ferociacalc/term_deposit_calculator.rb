...
require 'ferociacalc/input_definition'
...
module Ferociacalc
  class TermDepositCalculator
    ...
    def self.interest_rate_input
      ...
      Ferociacalc::InputDefinition.new(:interest_rate, description, to_type, validator, transformer)
    end

    def self.deposit_term_input
      to_type = ->(val) { Integer(val) }
      ...
      Ferociacalc::InputDefinition.new(:deposit_term, description, to_type, validator, transformer)
    end

    def self.interest_frequency_input
      to_type = ->(val) { String(val) }
      ...
      Ferociacalc::InputDefinition.new(:interest_frequency, description, to_type, validator, transformer)
    end
  end
end
